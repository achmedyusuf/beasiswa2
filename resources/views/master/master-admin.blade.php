        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                @auth
                    <div class="sidebar-user text-center">
                        ...
                        <div class="badge-bottom"><span class="badge badge-primary">
                            ...
                            {{ auth()->user()->role }}
                            @elseif (auth()->user()->role =="Tim Survey")
                            {{ auth()->user()->role }}
                            @else
                            Calon Peserta
                            @endif
                ...
                <div class="copyright">
                    <p><strong>PPDB BIDIKSIBA </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved</p>
                    <p class="fs-12">Made with <span class="heart"></span> by Anonymous</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/piaaasan/" target="_blank">Anonymous</a>
                </p>
            </div>
        </div>
        <!--**********************************
