...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Masuk dan Daftar | Bidiksiba</title>
        ...
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <br>
                    ...
                    <div class="google-btn">
                        <div class="google-icon-wrapper">
                            <a href="/auth/google">
                                <!-- Menambahkan pengaturan ukuran gambar -->
                                <img class="google-icon" src="sipenmaru\images\Google__G__logo.svg.png" width="40" height="40" />
                            </a>
                        </div>
                    </div>
                <hr>
                ...
                <div class="social-media">
                    <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwik3Ju6vdKEAxV5XWwGHQTMCXAQFnoECA0QAQ&url=https%3A%2F%2Fwww.facebook.com%2FBukitAsamOfficial%2F%3Flocale%3Did_ID&usg=AOvVaw3LKunPT3a7lLNVkWSn81p0&opi=89978449" class="social-icon">
                        <i class="fab fa-facebook-f"></i>
                    </a>
                    <a href="https://www.instagram.com/bukitasamptba/?img_index=1" class="social-icon">
                        <i class="fab fa-instagram"></i>
                    </a>
                    <a href="https://twitter.com/BukitAsamPTBA?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="social-icon">
                        <i class="fab fa-twitter"></i>
                    </a>
                    <a href="https://www.ptba.co.id" class="social-icon">
                ...
                <div class="google-btn">
                    <div class="google-icon-wrapper">
                        <a href="/auth/google">
                            <img class="google-icon" src="sipenmaru\images\Google__G__logo.svg.png" height="40" width="40"/>
                        </a>
                    </div>
                  </div>
                <hr>
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    <h3>Baru disini?</h3>
                    <p>
                        Silahkan daftar akun untuk melanjutkan proses pendaftaran peserta baru!
                    </p>
                    <button class="btn transparent" id="sign-up-btn">
                        DAFTAR
                    </button>
                </div>
                <img src="{{ asset('sipenmaru/images/login.png') }}" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                <div class="content">
                    <h3>Sudah punya akun?</h3>
                    <p>
                        Silahkan masuk jika anda telah memiliki akun pendaftaran peserta baru.
                    </p>
                    <button class="btn transparent" id="sign-in-btn">
                        Masuk
                    </button>
                </div>
                <img src="{{ asset('sipenmaru/images/register.png') }}" class="image" alt="" />
            </div>
        </div>
    </div>
